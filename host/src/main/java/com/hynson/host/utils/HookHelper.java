...
public class HookHelper {
    ...
    public static void hookAMS() throws Exception {
        ...
        Field mInstanceField = ReflectUtil.getField(singletonClazz, "mInstance");
        // 获取IActivityManager
    ...
    public static void hookHandler() throws Exception {
        ...
        Field sCurrentActivityThreadField = ReflectUtil.getField(activityThreadClazz, "sCurrentActivityThread");
        ...
        Field mHField = ReflectUtil.getField(activityThreadClazz, "mH");
        // 获取ActivityThread主线程中Handler对象
        Handler mH = (Handler) mHField.get(currentActivityThread);

        // 将我们自己的HCallback对象赋值给mH的mCallback
        ReflectUtil.setField(Handler.class, "mCallback", mH, new HCallback(mH));
    }
    ...
    public static void hookInstrumentation(Context context) throws Exception {
        ...
        Field mInstrumentationField = ReflectUtil.getField(activityThreadClazz, "mInstrumentation");
        // 获取ActivityThread主线程对象(应用程序启动后就会在attach方法中赋值)
        Object currentActivityThread = sCurrentActivityThreadField.get(activityThreadClazz);
        // 获取Instrumentation对象
        ...
        ReflectUtil.setField(activityThreadClazz, "mInstrumentation", currentActivityThread, instrumentationProxy);
    }
}
